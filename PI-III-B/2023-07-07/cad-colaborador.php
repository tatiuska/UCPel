<!-- Cadastro Colaborador IMDAZ -->
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>IMDAZ - Criar cadastro: colaborador</title>
    <!-- CSS Bootstrap -->
...
<body>
    <?php
        // Inserir códigos da classe Pessoa e da Classe Colaborador
        //include "pessoa.php";
        ...
        $data_ingresso = $_POST['data_ingresso'] ?? "Não informado";
    ?>
    ...
    <main>
        <!-- Área do fomrulário de cadastro para colaborador -->
        <div class="container-fluid" id="area-cad-colaborador">
            <div class="row col-12" id="row-cad-colaborador">
                <h2>Cadastro: Funcionário</h2>
                <div class="col-expand-lg col-sm-4" id="bloco-cad-colaborador">    
                    <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
                        ...
                        <p id="form">
                            ...
                            <input type="text" id="projeto" name="projeto" value="<?=$projeto?>" required>
                        </p>
                        <p id="form">
                            <label for="data_ingresso">Data de Ingresso:</label><br>
                            <input type="date" id="data_ingresso" name="data_ingresso" value="<?=$data_ingresso?>" required>
                        </p>
                        <p id="form">
                ...
                <div class="col-expand-lg col-sm-4" id="resultado-cad-colaborador">
                    <section id="resultado-cadastro-colaborador">
                        ...
                        <?php 
                            ...
                            <b>Data de Ingresso:</b> $data_ingresso</p>";
                        ?>
                    </section>
                </div>
            </div>
