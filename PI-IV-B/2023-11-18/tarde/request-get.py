...
url_get_one = 'http://127.0.0.1:5000/api/usuarios/3'
...
# Faz uma requisição GET para a URL para obter um usuário específico (substitua <id> pelo ID desejado - linha 7)
